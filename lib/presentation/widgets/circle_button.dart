  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        padding: EdgeInsetsGeometry.symmetric(vertical: heightPadding),
        width: double.infinity,
        decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(200),
            color: unselected ? AppColors.whiteColor : AppColors.primary
        ),
        child: Text(
          title,
          style: unselected
              ? AppTextStyles.robotoRegular(size: 16, color: AppColors.primary)
              : AppTextStyles.robotoSemiBold(size: 20, color: AppColors.whiteColor),
        ),
      ),
    );
  }
